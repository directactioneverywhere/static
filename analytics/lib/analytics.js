// Liberally borrowed from https://github.com/philipwalton/analyticsjs-boilerplate.
 ...
 */
const TRACKING_ID = 'UA-37998621-1';
...
const trackCustomDimensions = () => {
  ...
  ga((tracker) => {
    let toSet = {};
    toSet[dimensions.TRACKING_VERSION] = TRACKING_VERSION;
    toSet[dimensions.CLIENT_ID] = tracker.get('clientId');
    toSet[dimensions.WINDOW_ID] = uuid();
    tracker.set(toSet);
  });
...
const sendInitialPageview = () => {
  let toSet = {};
  toSet[dimensions.HIT_SOURCE] = 'pageload';
  ga('send', 'pageview', toSet);
};
